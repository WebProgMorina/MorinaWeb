<x-app-layout>
    <div class="container py-8">
        <div class="max-w-xl mx-auto shadow sm:rounded-lg p-6 m-4"
            ...
            <h2 class="text-2xl font-semibold mb-4">Tambah Data B</h2>
            <form action="{{ route('pdfB.upload') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div>
                    ...
                    <!-- Tombol View -->
                    <a id="btn" href="{{ route('pdfB.view') }}">View PDFs</a>
                </div>
            </form>
        </div>
    </div>
