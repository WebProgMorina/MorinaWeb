...
use App\Models\Siswapc;

class PaketCController extends Controller
{
    /**
    ...
    {
        $students = Siswapc::all();
        return view('paketc.index', compact('students'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('paketc.index')->with('success', 'Data siswa berhasil ditambahkan.');
    }
}
